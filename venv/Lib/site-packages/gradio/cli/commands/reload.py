...
$ gradio main.py, to run main.py in reload mode where any changes in the main.py file or Gradio library reloads the demo.
$ gradio main.py my_demo, to use variable names other than "demo"
"""
